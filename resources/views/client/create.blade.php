...
<main class="mt-20 px-6 flex flex-col items-center">
    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-xl p-8">
            ...
            <p class="text-sm text-gray-500 mb-8">Enter the client details to add them to your system.</p>
            ...
            <form action="{{ route('client.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="status" class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Initial Status</label>
